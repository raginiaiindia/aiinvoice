  ...
  "uncertain_fields": []
        ...
        for img in images:
            ...
            if all_pages_data:
              ...
              print("🔍 ITEMS (lowercase):", all_pages_data[0].get("items"))
              print("🔍 ITEMS (capital):", all_pages_data[0].get("Items"))
             ...
             for page in all_pages_data:
                # 🔥 Handle both "items" and "Items"
                 ...
                 for item in items:
                   ...
                   # Use extracted taxable if available
            #        taxable = (
            #     safe_float(item.get("taxable_value")) or
            #     safe_float(item.get("Value")) or
            #     0.0
            # )
        ...
        # 🔥 Always calculate taxable yourself (DO NOT trust Gemini)
